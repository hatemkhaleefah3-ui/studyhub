...
function Router() { return <Switch>
  ...
  <Route path="/subjects/:id/progress" component={SubjectStudyHub} /><Route path="/subjects/:id/lectures" component={SubjectStudyHub} /><Route path="/subjects/:id/attachments" component={SubjectStudyHub} /><Route path="/subjects/:id" component={SubjectStudyHub} />
