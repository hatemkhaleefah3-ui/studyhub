...
import { DragEdgeAutoScroll } from '@/components/shared/DragEdgeAutoScroll';
...
function Router() { return <Switch>
  ...
  <Route path="/subjects/:subjectId/lectures/:lectureId" component={LectureEdit} /><Route path="/subjects/:subjectId/lectures/:lectureId/flashcards" component={FlashcardsMaker} /><Route path="/subjects/:subjectId/lectures/:lectureId/study" component={FlashcardsReader} />
...
function App() { return <QueryClientProvider client={queryClient}><TooltipProvider><StudyDataProvider><WouterRouter base={import.meta.env.BASE_URL.replace(/\/$/, '')}><DragEdgeAutoScroll /><AppShell><Router /></AppShell></WouterRouter></StudyDataProvider><Toaster /></TooltipProvider></QueryClientProvider>; }
export default App;
